        ...
        <div className="max-w-3xl mx-auto">
          ...
          >
            <div className="inline-flex items-center space-x-3 px-6 py-3 rounded-full mb-6" style={{ backgroundColor: 'rgba(155, 155, 132, 0.1)' }}>
              ...
              <span className="font-medium" style={{ color: '#656d4f' }}>Request Resources</span>
            </div>
            ...
            <p className="text-xl max-w-2xl mx-auto leading-relaxed" style={{ color: '#9b9b84' }}>
              ...
              Tell me what would help you most, and I'll create something just for you.
            </p>
          </motion.div>
            ...
            <form onSubmit={handleSubmit} className="space-y-8">
              ...
              {isSubmitted && (
                ...
                >
                  ...
                  <p>I'll review your request and create a personalized resource for your situation. You'll hear from me within 2-3 business days.</p>
                </motion.div>
              )}
            </form>
          </motion.div>
